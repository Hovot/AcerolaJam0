...
draw_healthbar(camera_get_view_x(view_camera[0]) + 10, camera_get_view_y(view_camera[0]) + 40, camera_get_view_x(view_camera[0]) + 50, camera_get_view_y(view_camera[0]) + 45, hp, c_black, c_red, c_green, 0, true, true)
